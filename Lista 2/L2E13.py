...
if num is "1":print("Domingo")
elif num is "2":print("Segunda-Feira")
elif num is "3":print("Terça-Feira")
elif num is "4":print("Quarta-Feira")
elif num is "5":print("Quinta-Feira")
elif num is "6":print("Sexta-Feira")
elif num is "7":print("Sábado")
